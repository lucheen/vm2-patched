...
const proxyHandlerHandler = Object.freeze({
	...
	get(target, name, receiver) {
		// Bloque explicitement les accès sensibles
		if (name === 'constructor' || name === '__proto__') {
			throw new VMError('Access denied');
		}
...
if (AsyncFunction && !allowAsync) {
	overrideWithProxy(global, 'AsyncFunction', AsyncFunction, AsyncErrorHandler);
} else {
